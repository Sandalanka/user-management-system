...
$query="UPDATE user SET name='{$name}' AND address='{$email}'WHERE id={$user_id}";
...
<body>
    ...
    <main>
<h1>Change password <span><a href="user.php">Back to page</a></span></h1>
